...
- [ ] **Cotas de régua de Gaspar — a maior lacuna que sobrou, e agora se sabe onde ela NÃO está.** A cidade tem 1.618 cotas de rua e nenhuma cota de régua: nada dispara aviso lá. A tabela de monitoramento do município foi lida (salva do navegador, em `data/brutos/`) e traz **o nível — 3,85 m em 31/08 22:59 — e nenhuma faixa de cota**. Sobram dois caminhos, e o primeiro é curto: salvar `defesacivil.gaspar.sc.gov.br/plano-de-contingencia`, que o menu do próprio site publica; ou ofício à Defesa Civil de Gaspar pedindo as cotas de atenção/alerta **e** a régua a que elas se referem.
