...
- [ ] **🔴 Rio do Sul: a fonte dos picos é o Histórico de Cheias da DEFESA CIVIL MUNICIPAL — e o "Portal GCD" não é (19/09/2026). Decisão tua para entrar.** A auditoria abriu `defesacivil.riodosul.sc.gov.br` → *Histórico de Cheias* (a navegação mantém a URL inicial; a tabela se atribui a *"Defesa Civil de Rio do Sul - Exportação de Dados"*) e leu as linhas que faltavam: **1983 — maio 7,35 · julho 13,58 · setembro 7,60**, e **2013 — setembro 10,39**. Sem nome de régua, sem dia nem hora. E abriu `www.gcd.com.br`: existe, e **não tem a tabela** — buscas por 1983 e 13,58 não acham nada. O rótulo dos nove registros estava errado desde o commit `9ae8f87`. **Cruzamento que dá confiança:** os três meses de 1983 em Rio do Sul (maio/julho/setembro) são **os mesmos três** que Blumenau tem em 1983 (20/05 12,52 · 09/07 15,34 · 24/09 11,75), na mesma ordem de tamanho — julho o maior nas duas. Não é coincidência de tabela copiada; é a mesma cheia descendo o Açu. **O que fica por conferir:** que os seis que já temos (1984 12,80 · 2011 12,96 · 2015 10,71 · 2017 10,89 · out/2023 11,86 · nov/2023 13,04) estão na mesma tabela — a auditoria só transcreveu as linhas novas. **Proposta pronta, se decidires:** (a) trocar o `fonte` dos nove para *"Defesa Civil de Rio do Sul — Histórico de Cheias (defesacivil.riodosul.sc.gov.br), 'Exportação de Dados'"* com nota do rótulo antigo; (b) entrar **quatro** registros novos — `1983-05` 7,35 · `1983-07` 13,58 · `1983-09` 7,60 · `2013-09` 10,39 —, `confianca: media`, `referencia: null`, `rio: itajai-acu`, data só com mês porque a fonte não dá o dia. O de julho passa a ser **o maior pico de Rio do Sul** (acima dos 13,04 de nov/2023). ⚠️ **Não atribuir** esses picos à Ponte Dom Tito Buss: o painel atual identifica essa estação, mas o histórico não liga suas linhas a régua nenhuma. O teste que trava a ausência de 1983/2013 cai junto com a entrada — de propósito.
...
- [ ] **🟠 "Portal GCD" não tem URL em lugar nenhum: nove registros de Rio do Sul cuja fonte não se consegue reabrir (19/09/2026).** O Jefferson abriu o portal para buscar as linhas de 1983 e 2013 e a busca interna não achou "a tabela" — e não achou porque **nós nunca soubemos em que página ela estava**. Os nove registros carregam só o rótulo *"Portal GCD — série histórica de Rio do Sul"*; entraram no commit `9ae8f87`, cuja mensagem diz que vieram *"do estudo documental da bacia e do material de apoio"*, sem link nem título. Nem a sigla está expandida. É furo de proveniência, e é o tipo que some se não for escrito. **Como fechar:** o histórico da Defesa Civil de Rio do Sul, já aberto e conferido pelo Jefferson — se ele traz os seis que temos (1984 12,80 · 2011 12,96 · 2015 10,71 · 2017 10,89 · out/2023 11,86 · nov/2023 13,04), **essa página é a origem** com nome trocado, o `fonte` dos nove passa a ser a URL, e 1983 e set/2013 entram como irmãos (`media`). Se não traz, o "GCD" é outra coisa e a Wikipédia (que bate ao centímetro nos seis) é a única pista.
...
- [ ] **🟠 Rio do Sul: faltam 1983 (13,58 m) e set/2013 (10,39 m) na nossa série — e 1983 seria o MAIOR pico da cidade (19/09/2026).** A Wikipédia lista oito cheias de Rio do Sul; **seis estão em `enchentes.json` e batem ao centímetro** com a série do Portal GCD (1984 12,80 · 2011 12,96 · 2015 10,71 · 2017 10,89 · out/2023 11,86 · nov/2023 13,04). Duas **não estão**: **1983 = 13,58 m** e **set/2013 = 10,39 m**. Seis de seis iguais é forte indício de que a tabela da Wikipédia foi transcrita da MESMA série GCD — e portanto de que as duas ausentes também estão lá, e a gente **pulou duas linhas** na importação. Pesa: 1983 é a maior cheia da história do vale em Blumenau (15,34 m), e a nossa série de Rio do Sul simplesmente não a tem; com 13,58 m ela passaria a ser a maior de Rio do Sul, acima de nov/2023. **Não entra por mim** — registro é decisão tua. Se entrar pela Wikipédia é `confianca: baixa` (compilação informal), `referencia: null`, como os outros nove; **melhor** é abrir o Portal GCD (a auditoria pelo Chrome alcança) e trazer as duas linhas da fonte, aí entram como os irmãos, `media`. Teste trava a ausência de 1983 e 2013 — cai no dia em que entrarem, para esta nota ser reescrita junto. Os três que temos e a Wikipédia não (1911, 1954, 1957) ficam como estão.
