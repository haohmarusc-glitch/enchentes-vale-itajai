...
- [ ] **Confluência Oeste × Sul em Rio do Sul — o traçado das duas cabeceiras chegou.** `data/brutos/rio-do-sul-rios-tracados.geojson` (Defesa Civil de Rio do Sul / API Asthon, 04/09) traz 10 rios em LineString, incluindo **Itajaí do Sul** (35 pontos) e **Itajaí do Oeste** (95) — que o projeto nunca teve. Dá para rodar `achar_confluencias.py` e achar por geometria onde as duas cabeceiras formam o Açu, porque a confluência cai **dentro** da cobertura. **Ficou em `data/brutos/`, não em `data/rios/`, de propósito:** a cobertura é só o trecho dentro/perto de Rio do Sul (o "Itajaí do Sul" de 35 pontos não é o curso que vem de Ituporanga), e desenhar esse pedaço como se fosse o rio afirmaria geografia errada na tela. Para virar traçado de mapa, completar pelo Overpass como os outros. Ver `docs/API-ASTHON-COMPLETA.md`.
