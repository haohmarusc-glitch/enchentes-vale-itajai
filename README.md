...
`data/cotas-ruas.json` — 2.893 registros de Blumenau, Rio do Sul, Brusque e Gaspar,
...
- [ ] **Conseguir as tabelas de cota de rua que faltam.** Rio do Sul e Blumenau saíram (ver Concluído). Brusque saiu também, pela camada de 2023 do KML original (ver Concluído). Restam: **Gaspar** (mapa "Pesquise sua cota"; o host deu timeout de conexão nas duas sondagens de 31/08/2026, vale repetir) e **Itajaí** (ArcGIS fechado por token — ofício à prefeitura). Hoje são **2.893 pontos**: 1.938 de Blumenau, 555 de Rio do Sul, 377 de Brusque e 23 de Gaspar.
