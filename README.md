...
- [ ] **Gatilho COMPOSTO de Gaspar: atenção por nível OU por chuva > 6 mm.** A legenda de `/estacao/ver/21` da Defesa Civil de Gaspar mostra que a atenção dispara também por chuva, não só por nível — Gaspar pode estar em atenção com o rio baixo. **Nenhuma outra cidade da bacia tem isso**, e a UI hoje só sabe disparar por nível. É gatilho que **acrescenta**, nunca remove, então entra sem risco de avisar mais tarde. Ver `docs/GASPAR-DADOS-NOVOS.md`.
