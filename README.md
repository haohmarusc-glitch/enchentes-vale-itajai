...
- [ ] **🟠 147 dos 215 registros de cheia estão calados pela referência (19/09/2026).** Medido ao construir o bloco de cheias: **72** em Blumenau estão na referência do **IBGE** (régua + 0,20 m) e **98** em Brusque e Rio do Sul estão **sem referência conferida**; sobram 68 em `régua` (Gaspar 48, Indaial 16, Blumenau 4). Blumenau tem a série mais longa da bacia e mostra **quatro** cheias no bot — o bloco diz quantas calou e por quê, mas dizer não é resolver. Os 72 do IBGE destravam com a verificação no HidroWeb que a REGRA BLOQUEANTE já espera (estação 83800002, cotas de 09/07/1983 e 07/08/1984); os 98 de Brusque e Rio do Sul dependem de conferir a régua de origem na fonte.
