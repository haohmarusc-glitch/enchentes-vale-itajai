...
- [ ] Evento de **nov/2023 não tem nenhum registro** em `enchentes.json`. Só a telemetria da ANA dá pico, e as estações de Rio do Sul (83300200), Blumenau (83800002) e José Boiteux (83360000) ainda transmitiam em 2023. Rodar na VPS `sonda_ana_api.py --estacoes 83300200,83800002,83360000` para as janelas `--data 2023-11-17` e `2023-11-24`, `--intervalo DIAS_7`. Precisa de pull na VPS.
- [ ] **83360000 "Jose Boiteux"** (José Boiteux, Rio Itajaí do Norte/Hercílio) aparece nos avisos de 2023 e **não está em `estacoes.json`**. Mesmo ramo do Ibirama, que segue com `codigo_ana: null`. Investigar antes de cadastrar: é outro município, a montante.
