...
- [ ] **🟠 MÉDIA — "Enche com ~80 mm" nas barragens.** O JICA 2011 define esses valores como **capacidade ÷ área de drenagem** — equivalência volumétrica, não limiar de chuva; condição inicial, escoamento e operação não entram na divisão. Também há divergência de capacidade entre a ficha histórica (83 / 93,5 hm³) e a Asthon (~99,96 / 104,03), que **exige conciliação de época, não substituição automática**.
